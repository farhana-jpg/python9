...
class Command(_Command):
    ...
    When creating a new command from scratch, custom.css defined classes **SHOULD** inherit
    ...
    When overwriting existing commands, custom.css defined classes **MUST** abide by the
